...
void HelloTriangleApplication::pickPhysicalDevice() {
    ...
    //TODO: Better device choosing algorithm
...
void HelloTriangleApplication::createLogicalDevice() {
    ...
    std::transform(uniqueQueueFamilies.begin(),uniqueQueueFamilies.end(),queueCreateInfos.begin(),[queuePriority](int queueFamily){
...
void HelloTriangleApplication::createGraphicsPipeline(){
    auto vertShaderCode = readFile("res/shaders/triangle/out/vert.spv");
    auto fragShaderCode = readFile("res/shaders/triangle/out/frag.spv");
...
void HelloTriangleApplication::createDescriptorSet() {
    ...
    //TODO: Hier Funktionuckelt was nicht!
...
VkBool32
HelloTriangleApplication::debugCallback(VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objType, uint64_t obj,
